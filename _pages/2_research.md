...
<div class="row">
  <div class="col-sm-2 abbr">
    <abbr class="badge">ICCA 2024</abbr>
  </div>
  <div class="col-sm-10">
    <div class="title">Early Detection of Suicidal Ideation Using Bidirectional GRU and Language Models</div>
    <div class="author">
      <strong>Shakil Mahmud Shuvo</strong>, Navia Novely, Md. Farukuzzaman Faruk, Azmain Yakin Srizon, S. M. Mahedy Hasan
    </div>
    <div class="periodical">
      <em>Proceedings of the 3rd International Conference on Computing Advancements</em>, 2024
    </div>
    <div class="note"><span class="badge badge-danger">First Author</span></div>
    <div class="links">
      <a href="https://dl.acm.org/doi/10.1145/3723178.3723242" class="btn btn-sm btn-outline-primary" target="_blank">Paper</a>
    </div>
  </div>
</div>
</li>
...
<div class="row">
  ...
  <div class="col-sm-10">
    <div class="title">Improving Pre-Trained CNNs with CBAM and Skip Connections for Multi-Class Retinal Diseases Classification using OCT Images</div>
    <div class="author">
    ...
    <div class="links">
      <a href="https://dl.acm.org/doi/10.1145/3723178.3723304" class="btn btn-sm btn-outline-primary" target="_blank">Paper</a>
    </div>
  </div>
</div>
</li>
...
<div class="row">
  ...
  <div class="col-sm-10">
    <div class="title">Advancing Glioma Segmentation: A Robust 3D Residual Attention U-Net Framework for Multimodal MRI Images</div>
    <div class="author">
    ...
    <div class="links">
      <a href="https://dl.acm.org/doi/10.1145/3723178.3723308" class="btn btn-sm btn-outline-primary" target="_blank">Paper</a>
    </div>
  </div>
</div>
</li>
...
<div class="row">
  <div class="col-sm-2 abbr">
    <abbr class="badge">BIM 2023</abbr>
  </div>
  <div class="col-sm-10">
    <div class="title">Multi-class Brain Tumor Classification with DenseNet-Based Deep Learning Features and Ensemble of Machine Learning Approaches</div>
    <div class="author">
    ...
    <div class="periodical">
      <em>Proceedings of the 2nd International Conference on Big Data, IoT and Machine Learning</em>, 2023
    </div>
    <div class="note"><span class="badge badge-danger">First Author</span></div>
    <div class="links">
      <a href="https://link.springer.com/chapter/10.1007/978-981-99-8937-9_37" class="btn btn-sm btn-outline-primary" target="_blank">Paper</a>
    </div>
  </div>
</div>
</li>
...
<div class="row">
  <div class="col-sm-2 abbr">
    <abbr class="badge">NCIM 2023</abbr>
  </div>
  <div class="col-sm-10">
    <div class="title">A Late Fusion Deep CNN Model for the Classification of Brain Tumors from Multi-Parametric MRI Images</div>
    <div class="author">
      Anirban Barai, Md. Farukuzzaman Faruk, <strong>Shakil Mahmud Shuvo</strong>, Azmain Yakin Srizon, S. M. Mahedy Hasan, Abu Sayeed
    </div>
    <div class="periodical">
      <em>Proceedings of the 2023 International Conference on Next-Generation Computing, IoT and Machine Learning</em>, 2023
    </div>
    <div class="note"><span class="badge badge-secondary">Third Author</span></div>
    <div class="links">
      <a href="https://ieeexplore.ieee.org/document/10212729" class="btn btn-sm btn-outline-primary" target="_blank">Paper</a>
    </div>
  </div>
</div>
</li>
...
<div class="row">
  ...
  <div class="col-sm-10">
    <div class="title">Attention Mechanism-Enhanced Deep CNN Architecture for Precise Multi-class Leukemia Classification</div>
    <div class="author">
    ...
    <div class="links">
      <a href="https://link.springer.com/chapter/10.1007/978-981-99-8937-9_24" class="btn btn-sm btn-outline-primary" target="_blank">Paper</a>
    </div>
  </div>
</div>
</li>
